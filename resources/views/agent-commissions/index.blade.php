<x-app-layout>
    ...
    <x-slot name="headerActions">
        @can('create', App\Models\AgentCommission::class)
            <a href="{{ route('agent-commissions.create') }}" class="inline-flex items-center gap-2 rounded-md bg-slate-900 px-3 py-2 text-xs font-semibold text-white hover:bg-slate-800">
