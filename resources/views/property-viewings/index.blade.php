<x-app-layout>
    ...
    <x-slot name="headerActions">
        @can('create', App\Models\PropertyViewing::class)
            <a href="{{ route('property-viewings.create') }}" class="inline-flex items-center gap-2 rounded-md bg-slate-900 px-3 py-2 text-xs font-semibold text-white hover:bg-slate-800">
