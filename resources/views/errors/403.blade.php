...
<head>
    ...
    <title>{{ __('403 - Forbidden') }} - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p class="error-message">
            {{ __("You don't have permission to access this page. Please contact your administrator if you believe this is an error.") }}
        </p>
