            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    @can('create', App\Models\Contact::class)
                        ...
                        <a href="{{ $createRoute }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg focus:ring-2 focus:ring-offset-2 transition-all shadow-sm {{ $tenantCtx ? 'bg-gray-50 hover:bg-slate-800 focus:ring-slate-500' : 'bg-[#e8604c] hover:bg-[#d4503e] focus:ring-[#e8604c]' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @can('create', App\Models\Contact::class)
                                            <div class="mt-4 flex items-center gap-3 justify-center">
                                                ...
                                                <a href="{{ $createRoute }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-sm font-semibold rounded-lg hover:bg-slate-800 transition-colors">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
