        ...
        <div class="max-w-7xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                ...
                @can('create', App\Models\Resident::class)
                    <a href="{{ route('residents.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-50 text-sm font-semibold rounded-lg hover:bg-slate-800 focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 transition-all shadow-sm">
                            ...
                            <tr>
                                <td class="px-6 py-16" colspan="4">
                                    <div class="text-center">
                                        ...
                                        @can('create', App\Models\Resident::class)
                                            <a href="{{ route('residents.create') }}" class="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-sm font-semibold rounded-lg hover:bg-slate-800 transition-colors">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
