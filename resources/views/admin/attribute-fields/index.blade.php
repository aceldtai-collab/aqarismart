<x-admin-layout>
    ...
    <x-slot name="headerActions">
        <a href="{{ route('admin.attribute-fields.create', request()->only('lang')) }}" class="inline-flex items-center gap-2 rounded-md bg-gray-50 px-3 py-2 text-xs font-semibold hover:bg-slate-800">
